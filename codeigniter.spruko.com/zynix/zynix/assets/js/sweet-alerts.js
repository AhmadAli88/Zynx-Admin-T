(function () {
    ...
    document.getElementById('alert-image').onclick = function () {
        Swal.fire({
            ...
            imageUrl: 'https://codeigniter.spruko.com/zynix/zynix/assets/images/media/media-59.jpg',
            imageWidth: 400,
            imageHeight: 200,
    ...
    document.getElementById('alert-custom-bg').onclick = function () {
        Swal.fire({
            ...
            padding: '3em',
            color: '#716add',
            background: 'url(https://codeigniter.spruko.com/zynix/zynix/assets/images/media/media-19.jpg)',
            backdrop: `
              rgba(0,0,0,0.3)
              url(https://codeigniter.spruko.com/zynix/zynix/assets/images/gif's/1.gif)
              left top
              no-repeat
            `
        })
