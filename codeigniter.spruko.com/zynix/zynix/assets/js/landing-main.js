...
function ltrFn() {
  ...
  document
    .querySelector("#style")
    ?.setAttribute("href", "https://codeigniter.spruko.com/zynix/zynix/assets/libs/bootstrap/css/bootstrap.min.css");
  html.setAttribute("dir", "ltr");
...
function rtlFn() {
  ...
  document
    ...
    ?.setAttribute(
      "href",
      "https://codeigniter.spruko.com/zynix/zynix/assets/libs/bootstrap/css/bootstrap.rtl.min.css"
    );
  checkOptions();
}
