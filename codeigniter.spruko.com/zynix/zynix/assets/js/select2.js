(function () {
  ...
  function formatState(state) {
      ...
      var baseUrl = "https://codeigniter.spruko.com/zynix/zynix/assets/images/faces/select2";
      var $state = $(
  ...
  function selectClient(client) {
      ...
      var $client = $(
          '<span><img src="https://codeigniter.spruko.com/zynix/zynix/assets/images/faces/select2/' + client.element.value.toLowerCase() + '.jpg" /> '
          + client.text + '</span>'
      );
      return $client;
  };
