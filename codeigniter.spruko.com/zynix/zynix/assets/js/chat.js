...
let changeTheInfo = (element, name, img, status) => {
    ...
    let image = `https://codeigniter.spruko.com/zynix/zynix/assets/images/faces/${img}.jpg`
...
new FgEmojiPicker({
    ...
    position: ['top', 'right'],
    preFetch: true,
    dir:"https://codeigniter.spruko.com/zynix/zynix/assets/libs/fg-emoji-picker/"
});
